...
public class Index {
    ...
    public Index(){
        ...
        File directory = new File("/Users/tmarch1/Development/NetBeansProjects/490/490 Lab6-Classification/data/clean/");
        String files;
    ...
    public Index(String placeHolder){
        //A parameterized constructor in which the parameter serves no purpose
        //And the constructor does nothing.
        //Index will be filled later with text from the training docs
    }

    public void Read(String fileIn){

        try {
            String filePath = "/Users/tmarch1/Development/NetBeansProjects/490/490 Lab6-Classification/data/clean/" + fileIn;
    ...
    public void ReadArtist(String artistName, String artistText){
        //Create a (very large) array holding all of the text from the clean documents
        String[] textArr = artistText.split("\\s");


        for(int i = 0;i < textArr.length;i++){
            this.Insert(textArr[i], artistName, i);
        }
    }
     ...
     * Purpose: Calculates the comp-scores of each of the artist-documents
     * Parameter:
     *      List<String> termList - used to generate the correct size of unsortedArray
     * return Value:
     *      double[] unsortedArray - array storing each artist's comp-score in a specific index (dictated by ArtisttoIndexMap)
     * Precondition: PosIndexes have been created for all TrainingDocs and 1 TestDoc
     * Postcondition: unsortedArray is QuickSorted, and the matching IndexArray links back to specific artists
     */
    public double[] compareArtists(List<String> termList){
        //System.out.println("\nBeginning Comparison");
        HashMap cloneMap = (HashMap)termDict.clone();
        int arrSize = termList.size();
