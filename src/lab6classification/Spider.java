   ...
   public List getParsedText(String pageIn){
    ...
    public void fetch(String urlIn,String itemType, SearchDB base, int item){
        try{
            ...
            File rawFile = new File("/Users/tmarch1/Development/NetBeansProjects/490/490 Lab6-Classification/data/raw/" + fileName);
            ...
            File cleanFile = new File("/Users/tmarch1/Development/NetBeansProjects/490/490 Lab6-Classification/data/clean/" + fileName);
            ...
            File headerFile = new File("/Users/tmarch1/Development/NetBeansProjects/490/490 Lab6-Classification/data/header/" + fileName);
